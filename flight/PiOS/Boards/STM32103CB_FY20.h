...
#define PIOS_ADC_PIN1_GPIO_PORT			GPIOC			// PC3 (Accel X)
#define PIOS_ADC_PIN1_GPIO_PIN			GPIO_Pin_3		//
#define PIOS_ADC_PIN1_GPIO_CHANNEL		ADC_Channel_13
#define PIOS_ADC_PIN1_ADC				ADC1
#define PIOS_ADC_PIN1_ADC_NUMBER		1

#define PIOS_ADC_PIN2_GPIO_PORT			GPIOC			// PC4 (Accel Y)
#define PIOS_ADC_PIN2_GPIO_PIN			GPIO_Pin_4		//
#define PIOS_ADC_PIN2_GPIO_CHANNEL		ADC_Channel_14
#define PIOS_ADC_PIN2_ADC				ADC1
#define PIOS_ADC_PIN2_ADC_NUMBER		2

#define PIOS_ADC_PIN3_GPIO_PORT			GPIOC			// PC5 (Accel Z)
...
/*
#define PIOS_ADC_PIN4_GPIO_PORT			GPIOA			// PA5 ELEVATOR TRIMER //
#define PIOS_ADC_PIN4_GPIO_PIN			GPIO_Pin_5		//
#define PIOS_ADC_PIN4_GPIO_CHANNEL		ADC_Channel_5
#define PIOS_ADC_PIN4_ADC				ADC1
#define PIOS_ADC_PIN4_ADC_NUMBER		4

#define PIOS_ADC_PIN9_GPIO_PORT			GPIOA			// PA7 RUDER TRIMER //
#define PIOS_ADC_PIN9_GPIO_PIN			GPIO_Pin_7		//
#define PIOS_ADC_PIN9_GPIO_CHANNEL		ADC_Channel_7
#define PIOS_ADC_PIN9_ADC				ADC1
#define PIOS_ADC_PIN9_ADC_NUMBER		5
*/
// ADC2
#define PIOS_ADC_PIN4_GPIO_PORT			GPIOC			// PC0 (Gyro X)
#define PIOS_ADC_PIN4_GPIO_PIN			GPIO_Pin_0		//
#define PIOS_ADC_PIN4_GPIO_CHANNEL		ADC_Channel_10
#define PIOS_ADC_PIN4_ADC				ADC2
#define PIOS_ADC_PIN4_ADC_NUMBER		1

#define PIOS_ADC_PIN5_GPIO_PORT			GPIOC			// PC1 (Gyro Y)
#define PIOS_ADC_PIN5_GPIO_PIN			GPIO_Pin_1		//
#define PIOS_ADC_PIN5_GPIO_CHANNEL		ADC_Channel_11
#define PIOS_ADC_PIN5_ADC				ADC2
#define PIOS_ADC_PIN5_ADC_NUMBER		2

#define PIOS_ADC_PIN6_GPIO_PORT			GPIOC			// PC2 (Gyro Z)
#define PIOS_ADC_PIN6_GPIO_PIN			GPIO_Pin_2		//
#define PIOS_ADC_PIN6_GPIO_CHANNEL		ADC_Channel_12
#define PIOS_ADC_PIN6_ADC				ADC2
#define PIOS_ADC_PIN6_ADC_NUMBER		3
/*
#define PIOS_ADC_PIN8_GPIO_PORT			GPIOA			// PA6 AILERON TRIMER //
#define PIOS_ADC_PIN8_GPIO_PIN			GPIO_Pin_6		//
#define PIOS_ADC_PIN8_GPIO_CHANNEL		ADC_Channel_6
#define PIOS_ADC_PIN8_ADC				ADC2
#define PIOS_ADC_PIN8_ADC_NUMBER		4

#define PIOS_ADC_PIN10_GPIO_PORT		GPIOB			// PB0 SPEED
#define PIOS_ADC_PIN10_GPIO_PIN			GPIO_Pin_0		//
#define PIOS_ADC_PIN10_GPIO_CHANNEL		ADC_Channel_8
#define PIOS_ADC_PIN10_ADC				ADC2
#define PIOS_ADC_PIN10_ADC_NUMBER		5
*/
#define PIOS_ADC_NUM_PINS			6 //10
...
/*
#define PIOS_ADC_PORTS				{ PIOS_ADC_PIN1_GPIO_PORT, PIOS_ADC_PIN2_GPIO_PORT, PIOS_ADC_PIN3_GPIO_PORT, PIOS_ADC_PIN4_GPIO_PORT, PIOS_ADC_PIN5_GPIO_PORT, PIOS_ADC_PIN6_GPIO_PORT, PIOS_ADC_PIN7_GPIO_PORT, PIOS_ADC_PIN8_GPIO_PORT, PIOS_ADC_PIN9_GPIO_PORT, PIOS_ADC_PIN10_GPIO_PORT }
#define PIOS_ADC_PINS				{ PIOS_ADC_PIN1_GPIO_PIN, PIOS_ADC_PIN2_GPIO_PIN, PIOS_ADC_PIN3_GPIO_PIN, PIOS_ADC_PIN4_GPIO_PIN, PIOS_ADC_PIN5_GPIO_PIN, PIOS_ADC_PIN6_GPIO_PIN, PIOS_ADC_PIN7_GPIO_PIN, PIOS_ADC_PIN8_GPIO_PIN, PIOS_ADC_PIN9_GPIO_PIN, PIOS_ADC_PIN10_GPIO_PIN }
#define PIOS_ADC_CHANNELS			{ PIOS_ADC_PIN1_GPIO_CHANNEL, PIOS_ADC_PIN2_GPIO_CHANNEL, PIOS_ADC_PIN3_GPIO_CHANNEL, PIOS_ADC_PIN4_GPIO_CHANNEL, PIOS_ADC_PIN5_GPIO_CHANNEL, PIOS_ADC_PIN6_GPIO_CHANNEL, PIOS_ADC_PIN7_GPIO_CHANNEL, PIOS_ADC_PIN8_GPIO_CHANNEL, PIOS_ADC_PIN9_GPIO_CHANNEL, PIOS_ADC_PIN10_GPIO_CHANNEL }
#define PIOS_ADC_MAPPING			{ PIOS_ADC_PIN1_ADC, PIOS_ADC_PIN2_ADC, PIOS_ADC_PIN3_ADC, PIOS_ADC_PIN4_ADC, PIOS_ADC_PIN5_ADC, PIOS_ADC_PIN6_ADC, PIOS_ADC_PIN7_ADC, PIOS_ADC_PIN8_ADC, PIOS_ADC_PIN9_ADC, PIOS_ADC_PIN10_ADC }
#define PIOS_ADC_CHANNEL_MAPPING	{ PIOS_ADC_PIN1_ADC_NUMBER, PIOS_ADC_PIN2_ADC_NUMBER, PIOS_ADC_PIN3_ADC_NUMBER, PIOS_ADC_PIN4_ADC_NUMBER, PIOS_ADC_PIN5_ADC_NUMBER, PIOS_ADC_PIN6_ADC_NUMBER, PIOS_ADC_PIN7_ADC_NUMBER, PIOS_ADC_PIN8_ADC_NUMBER, PIOS_ADC_PIN9_ADC_NUMBER, PIOS_ADC_PIN10_ADC_NUMBER }
 *
 *
 */
...
#define PIOS_ADC_MAX_OVERSAMPLING              20 //36
